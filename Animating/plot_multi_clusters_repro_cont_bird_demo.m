...
function M = plot_multi_clusters_repro_cont_bird_demo(mocapstruct,ind_cell,nframes,v,fighand,titlein)
    ...
    for ll = 1:num_vids  %numel(cluster_numbers)
        ...
        if viduse <=numel(ind_cell)
            ...
            if movie_size>0
                ...
                M_indiv{ll} =  plot_frame_dannce_reprojection_multi_bird_demo(mocapstruct,frames_plot_here,...
